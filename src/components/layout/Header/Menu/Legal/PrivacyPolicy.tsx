            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10 no-scrollbar pb-20">
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        <p><span className="text-[var(--c-text)]">1.1. Telegram</span> – мессенджер Telegram, платформа для создания и использования мини-приложений (Mini Apps). Mini App «Гороскоп» размещено и доступно в Telegram.</p>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p>2.4. Актуальная редакция Политики всегда доступна через меню Приложения.</p>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        <p>4.1. Разработчик может получать от платформы Telegram следующие сведения о Пользователе:</p>
                        <ul className="list-disc list-inside space-y-1 pl-2">
                            <li>идентификатор пользователя (Telegram ID);</li>
                            <li>имя и фамилию;</li>
                            <li>имя пользователя (username);</li>
                            <li>язык интерфейса;</li>
                            <li>иные данные, передаваемые платформой Telegram в рамках Mini Apps API.</li>
                        </ul>
                        ...
                        <p>4.4. Для учёта приобретённой Подписки NOVA Premium могут обрабатываться сведения о факте оплаты, идентификаторе платежа, сроке действия Подписки.</p>
                        <p>4.5. Оплата Подписки NOVA Premium при её приобретении осуществляется через платёжную систему Telegram Stars. Разработчик получает от платёжной системы сведения о факте совершения платежа, количестве звёзд и идентификаторе транзакции. Иные платёжные данные Пользователей Разработчику не передаются.</p>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p>5.3. Технические настройки сохраняются локально в браузере (LocalStorage). Разработчик не передаёт и не хранит персональные данные Пользователей на своих серверах.</p>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p>7.2. В Приложении предусмотрена функция «Удалить аккаунт», доступная в настройках. Удаление аккаунта приводит к очистке всех данных, сохранённых в браузере, и данных, доступных Разработчику. Удаление аккаунта может повлечь утрату доступа к Подписке NOVA Premium и иным пользовательским данным, восстановление которых может оказаться невозможным.</p>
                    </div>
                </section>
