            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10 no-scrollbar pb-20">
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p>5.3. Технические настройки сохраняются локально в браузере (LocalStorage). Разработчик не передаёт и не хранит персональные данные Пользователей на своих серверах, за исключением обезличенного идентификатора пользователя для проверки статуса подписки.</p>
