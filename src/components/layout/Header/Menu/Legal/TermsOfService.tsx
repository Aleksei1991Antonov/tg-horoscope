            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10 no-scrollbar pb-20">
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p><span className="text-[var(--c-text)]">6.2.</span> Стоимость Подписки устанавливается в звёздах Telegram (Telegram Stars) и указывается в интерфейсе Приложения на момент оформления заказа, если иная стоимость не указана.</p>
                        ...
                        <p><span className="text-[var(--c-text)]">6.3.</span> Оплата Подписки производится через платёжную систему Telegram Stars.</p>
                        <p>Обработка платежей осуществляется платформой Telegram в соответствии с её правилами и условиями использования.</p>
                        <p>Разработчик не получает и не хранит платёжные данные Пользователей.</p>
