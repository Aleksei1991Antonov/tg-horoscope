            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-10 no-scrollbar pb-20">
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p>2.3. Действующая редакция доступна по ссылке: <button onClick={() => window.Telegram?.WebApp?.openLink('https://dev.max.ru/docs/legal/agreement')} className="text-[var(--c-primary)] underline">dev.max.ru/docs/legal/agreement</button>.</p>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-3`}>
                        ...
                        <p>5.6. Разработчик не несёт ответственности за перебои, ошибки и ограничения в работе платформы MAX, платёжных сервисов, операторов связи и иных третьих лиц, находящиеся вне разумного контроля Разработчика.</p>
                    </div>
                </section>
                ...
                <section className="space-y-4">
                    ...
                    <div className={`${bodyTextSize} leading-relaxed text-[var(--c-text-60)] font-medium space-y-2`}>
                        ...
                        <p><span className="text-[var(--c-text)]">6.4.</span> Подписка привязывается к конкретному устройству Пользователя, на котором была произведена её активация.</p>
                        <p>Для идентификации устройства могут использоваться технические механизмы платформы MAX, включая DeviceStorage и иные средства хранения данных.</p>
                        <p>Перенос Подписки между устройствами может быть ограничен техническими особенностями платформы MAX и Приложения.</p>
