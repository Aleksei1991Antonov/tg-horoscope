                        ...
                        <div className="p-[1.5rem] pt-[3rem] flex-1">
                            ...
                            <div className="space-y-[2rem]">
                                ...
                                <div className="space-y-[0.75rem]">
                                    ...
                                    <button onClick={() => { void triggerSuccessHaptic(); window.Telegram?.WebApp?.openLink(`mailto:${supportEmail}`); }} className="w-full p-[1.25rem] rounded-[1.2rem] bg-[var(--c-surface)] border border-[var(--c-border)] flex items-center gap-[0.75rem] active:scale-[0.98]">
